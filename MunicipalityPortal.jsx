...
const PAY_SERVICES = [
  { title: "عوارض نوسازی", desc: "پرداخت و پیگیری قبض" },
  { title: "عوارض کسب و پیشه", desc: "پرداخت عوارض واحد صنفی" },
  { title: "بدهی نوسازی ملک", desc: "مشاهده و تسویه بدهی" },
  { title: "فیش درآمد", desc: "دریافت و پرداخت آنلاین" },
];

const INFO_SERVICES = [
  { title: "شناسایی کد نوسازی", desc: "بر اساس آدرس یا مالکیت" },
  { title: "سوابق پرونده ملک", desc: "مشاهده سابقه‌ی مجاز" },
  { title: "آراء کمیسیون ماده صد", desc: "پیگیری نتیجه رأی" },
  { title: "تأیید اعتبار گواهی", desc: "استعلام صحت مدارک" },
];

const CIVIC_SERVICES = [
  { title: "صدور گواهی شهرداری", desc: "ثبت درخواست جدید" },
  { title: "پیگیری درخواست‌ها", desc: "وضعیت پرونده‌های ارسالی" },
  { title: "ثبت اعتراض ملکی", desc: "سامانه اعتراضات ممیزی" },
];
      ...
      <header className="topbar">
        <div className="wrap topbar-inner">
          ...
          <div className="top-actions">
            <a className="btn btn-ghost" href="#">ورود شهروند</a>
            <a className="btn btn-solid" href="#">ثبت‌نام</a>
